	...
	describe('timeAgo', () => {
		test('formats the relative time', () => {
			...
			expect(
				timeAgo({
					date: new Date('2021-01-01T00:00:00Z'),
					now: new Date('2021-01-01T00:01:00Z'),
				}),
			).toBe('a minute ago')
			expect(
				timeAgo({
			...
			expect(
				timeAgo({
					date: new Date('2021-01-01T00:00:00Z'),
					now: new Date('2021-01-01T01:00:00Z'),
				}),
			).toBe('an hour ago')
			expect(
				timeAgo({
					date: new Date('2021-01-01T00:00:00Z'),
					now: new Date('2021-01-01T02:00:00Z'),
				}),
			).toBe('2 hours ago')
			expect(
				timeAgo({
					date: new Date('2021-01-01T00:00:00Z'),
					now: new Date('2021-01-02T00:00:00Z'),
				}),
			).toBe('a day ago')
			expect(
				timeAgo({
			...
			expect(
				timeAgo({
					date: new Date('2021-01-01T00:00:00Z'),
					now: new Date('2021-02-01T00:00:00Z'),
				}),
			).toBe('a month ago')
			expect(
				timeAgo({
					date: new Date('2021-01-01T00:00:00Z'),
					now: new Date('2021-03-02T00:00:00Z'),
				}),
			).toBe('2 months ago')
			expect(
				timeAgo({
