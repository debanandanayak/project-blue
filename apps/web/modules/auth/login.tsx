            ...
            <div>
                <div className="flex flex-col gap-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                            <Button variant="outline" disabled={!authConfig.providers.github.isEnabled} type="button" className="w-full">
                            ...
                            <Button variant="outline" disabled={!authConfig.providers.google.isEnabled} type="button" className="w-full">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
